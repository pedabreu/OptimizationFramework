setConstructorS3("SwapSequence10x10",function()
{
  extend(SwapSequence(),"SwapSequence10x10")  
})




setMethodS3("DBsave","SwapSequence10x10", function(this,con=NULL,...) {
  
  DBobj<-DBSwapSequence10x10()
...
setMethodS3("DBgetByUniqueID","SwapSequence10x10", function(this,uniqueID = NULL,con=NULL,...) {
...
setMethodS3("DBgetAllByAttributes","SwapSequence10x10", function(this,attributes = list(),con=NULL,...) {
