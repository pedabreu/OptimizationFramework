setConstructorS3("MachineFeaturedElement",function()
{
  swpSeq <- Machine()
  ...
  extend(featElmt,"MachineFeaturedElement")
})

setMethodS3("HistrogramOfOperationBasic_4_2","MachineFeaturedElement", 
