setConstructorS3("SwapSequence10x10FeaturedElement",function()
{
  swpSeq <- SwapSequence10x10()
  
  obj <- SwapSequenceFeaturedElement()
  
  obj$object <- swpSeq
  
  extend(obj,"SwapSequence10x10FeaturedElement")
})


setMethodS3("getObjectTableName","SwapSequence10x10FeaturedElement", function(this,
                                                             ...) {  
  return("SwapSequence10x10")  
})


setMethodS3("featuresNewSequence10x10JobsDistribution2","SwapSequence10x10FeaturedElement", function(this,
                                                                                                 ...) {
...
setMethodS3("featuresNewSequence10x10MachineDistribution1","SwapSequence10x10FeaturedElement", function(this,
                                                                                                 ...) {
...
setMethodS3("featuresNewSequence10x10JobsDistribution1","SwapSequence10x10FeaturedElement", function(this,
                                                                                           ...) {
...
setMethodS3("featuresSandeep","SwapSequence10x10FeaturedElement", function(this,...) {
...
setMethodS3("featuresJobMachineOrderIndexBased10x10","SwapSequence10x10FeaturedElement", function(this,...) {
...
setMethodS3("featuresOperationPartition10x10","SwapSequence10x10FeaturedElement", function(this,...) {
...
setMethodS3("featuresRelativeFeaturesOfIndexs","SwapSequence10x10FeaturedElement", function(this,...) {
...
setMethodS3("featuresOperationIndexBased10x10","SwapSequence10x10FeaturedElement", function(this,...) {
