setConstructorS3("SwapSequence3x3FeaturedElement",function()
{
  ...
  extend(obj,"SwapSequence3x3FeaturedElement")
})


setMethodS3("getObjectTableName","SwapSequence3x3FeaturedElement", function(this,
                                                             ...) {  
  return("SwapSequence3x3")  
})



setMethodS3("featuresJobMachineOrderIndexBased3x3","SwapSequence3x3FeaturedElement", function(this,...) {
...
setMethodS3("featuresOperationPartition3x3","SwapSequence3x3FeaturedElement", function(this,...) {
...
setMethodS3("featuresRelativeFeaturesOfIndexs","SwapSequence3x3FeaturedElement", function(this,...) {
...
setMethodS3("featuresOperationIndexBased3x3","SwapSequence3x3FeaturedElement", function(this,...) {
